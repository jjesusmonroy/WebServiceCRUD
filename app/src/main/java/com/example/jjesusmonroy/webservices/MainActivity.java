...
public class MainActivity extends AppCompatActivity {
    ...
    private class ObtenerAlumno extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(Void... voids) {
            try{
                URL url;
                if(parametro.equals(""))url = new URL("http://172.20.6.105/datos1/obtener_alumnos.php");
                else url = new URL("http://172.20.6.105/datos1/obtener_alumno_por_id.php?idalumno="+parametro);
